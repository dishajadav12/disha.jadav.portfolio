...
export const TextRevealCard = ({
  ...
  return (
    <div
      ...
      ref={cardRef}
      className={cn(
        "  w-[60rem] rounded-lg p-8 relative overflow-hidden flex flex-col justify-center items-center",
        className
      )}
    >
      {children}
      ...
      <div className="h-40  relative  overflow-hidden">
        ...
        >
          <p
            ...
            className="text-base sm:text-[3rem] py-10 font-bold text-white bg-clip-text bg-gradient-to-b from-white to-neutral-300 whitespace-nowrap"
          >
            {revealText}
          </p>
        </motion.div>
