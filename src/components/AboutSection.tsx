...
export default function AboutSection() {
  return (
    <section id="about" className="flex flex-col items-center py-6 overflow-hidden">
      <div className="-mt-10 md:mt-12 w-full max-w-[80rem] mx-auto text-center md:text-left px-4 md:pl-24 h-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-14 mb-10 h-full place-items-center lg:place-items-stretch">
          
          {/* Left column */}
          <div className="lg:col-span-7 h-full w-full">
            <div className="h-full backdrop-blur p-6 shadow-sm flex flex-col items-center md:items-start">
          ...
          <div className="w-full flex justify-center lg:justify-start">
            <CometCard className="my-0 md:my-20 z-50">
              <button
                type="button"
                aria-label="View invite F7RA"
                className={cn(
                  "flex w-80 mx-auto cursor-pointer flex-col items-stretch rounded-[16px] border border-[rgba(255,255,255,0.06)]",
              ...
              >
                <div className="mx-2 flex-1">
                  <div className="relative mt-2 aspect-[3/4] w-full">
                    <Image
                      ...
                      style={{ boxShadow: "0 6px 10px rgba(0, 15, 29, 0.4)" }}
                    />
                  </div>
                </div>
                ...
                <div className="mt-2 flex flex-shrink-0 items-center justify-between p-4 font-mono text-[rgba(236,246,255,0.95)]">
                  ...
                  <div className="text-xs text-[rgba(236,246,255,0.6)]">MSSE @ SJSU</div>
                </div>
              </button>
            </CometCard>
          </div>
